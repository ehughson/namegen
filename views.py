...
def home():
	...
	if request.method == 'POST':
		...
		add_to_dict(d, asra_pre_names, "sunce", 'suffix')
		add_to_dict(d, asra_suf_names, "sunce", "prefix")

		add_to_dict(d, cansu_pre_names, "sunce", 'suffix')
		add_to_dict(d, cansu_suf_names, "sunce", "prefix")

		add_to_dict(d, misc_pre_names, "sunce", 'suffix')
		add_to_dict(d, misc_suf_names, "sunce", "prefix")


		add_to_dict(d, fail_pre_names, "sunce", 'suffix')
		add_to_dict(d, fail_suf_names, "sunce", "prefix")
		...
		return render_template('home.html', pre_name = chosen_pre, suf_name = chosen_suf, s_desc = "The name " + chosen_suf + " means: " + suf_description, p_desc = "The name " + chosen_pre + " means: " + pre_description)
	else:
